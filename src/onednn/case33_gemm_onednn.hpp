...
/* Case 3.3 Intel GPU: gemmstone / oneDNN catalog int8 GEMM + milestoned tile XOR + host jackpot. */
...
private:
    ...
    bool scan_tile_xor_panel_(const uint32_t a_key8[8], const uint32_t bound[8],
